...
void FitJetCharge() {
  ...
  TString filename = "/home/ilc/yokugawa/macros/QQbar250/analysis/ssbar/Polar/rootfiles/DQ_250GeV_uu.root";
  TFile *f = new TFile(filename);
  TH1F* h_pfo_q_match_charge = (TH1F*)f->Get("h_pfo_q_match_charge");
  TH1F* h_pfo_qbar_match_charge = (TH1F*)f->Get("h_pfo_qbar_match_charge");
  Normal(h_pfo_q_match_charge);
  Normal(h_pfo_qbar_match_charge);
  std::cout << filename << std::endl;

  makePretty(h_pfo_q_match_charge,2);
  makePretty(h_pfo_qbar_match_charge,4);
  ...
  leg->AddEntry(h_pfo_q_match_charge,"u matched PFO","fp");
  leg->AddEntry(h_pfo_qbar_match_charge,"#bar{u} matched PFO","fp");
  leg->Draw();
  ...
  p0 = h_pfo_qbar_match_charge->GetMaximum();
  p1 = h_pfo_qbar_match_charge->GetMean();
  p2 = h_pfo_qbar_match_charge->GetRMS();
  crystalball->SetLineColor(4);
  crystalball->SetParameters(p0,p1,p2,p3,p4);
  
  h_pfo_qbar_match_charge->Fit(crystalball,"SR");
