...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Int_t           mc_quark_ps_n;
   Float_t         mc_quark_ps_E[22];   //[mc_quark_ps_n]
   Float_t         mc_quark_ps_px[22];   //[mc_quark_ps_n]
   Float_t         mc_quark_ps_py[22];   //[mc_quark_ps_n]
   Float_t         mc_quark_ps_pz[22];   //[mc_quark_ps_n]
   Float_t         mc_quark_ps_m[22];   //[mc_quark_ps_n]
   Float_t         mc_quark_ps_pdg[22];   //[mc_quark_ps_n]
   Float_t         mc_quark_ps_charge[22];   //[mc_quark_ps_n]
   ...
   Int_t           pfo_n_j2;
   Int_t           jet_nvtx_j2;
   Int_t           pfo_match[157];   //[pfo_n]
   Int_t           pfo_truejet_pdg[157];   //[pfo_n]
   Int_t           pfo_truejet_type[157];   //[pfo_n]
   Int_t           pfo_pdgcheat[157];   //[pfo_n]
   Int_t           pfo_nparents[157];   //[pfo_n]
   Int_t           pfo_pdgcheat_parent[157][1000];   //[pfo_n]
   Float_t         pfo_E[157];   //[pfo_n]
   Float_t         pfo_px[157];   //[pfo_n]
   Float_t         pfo_py[157];   //[pfo_n]
   Float_t         pfo_pz[157];   //[pfo_n]
   Float_t         pfo_m[157];   //[pfo_n]
   Int_t           pfo_type[157];   //[pfo_n]
   Int_t           pfo_isoverlay[157];   //[pfo_n]
   Int_t           pfo_isisr[157];   //[pfo_n]
   Int_t           pfo_vtx[157];   //[pfo_n]
   Int_t           pfo_charge[157];   //[pfo_n]
   Int_t           pfo_ntracks[157];   //[pfo_n]
   Int_t           pfo_tpc_hits[157];   //[pfo_n]
   Float_t         pfo_dedx[157];   //[pfo_n]
   Float_t         pfo_dedxerror[157];   //[pfo_n]
   Float_t         pfo_d0[157];   //[pfo_n]
   Float_t         pfo_d0error[157];   //[pfo_n]
   Float_t         pfo_z0[157];   //[pfo_n]
   Float_t         pfo_z0error[157];   //[pfo_n]
   Float_t         pfo_phi[157];   //[pfo_n]
   Float_t         pfo_phierror[157];   //[pfo_n]
   Float_t         pfo_omega[157];   //[pfo_n]
   Float_t         pfo_omegaerror[157];   //[pfo_n]
   Float_t         pfo_tanlambda[157];   //[pfo_n]
   Float_t         pfo_tanlambdaerror[157];   //[pfo_n]
   Float_t         pfo_chi2[157];   //[pfo_n]
   Float_t         pfo_ndf[157];   //[pfo_n]
   Int_t           pfo_pid[157];   //[pfo_n]
   Float_t         pfo_pid_likelihood[157];   //[pfo_n]
   Float_t         pfo_pid_eprob[157];   //[pfo_n]
   Float_t         pfo_pid_muprob[157];   //[pfo_n]
   Float_t         pfo_pid_piprob[157];   //[pfo_n]
   Float_t         pfo_pid_kprob[157];   //[pfo_n]
   Float_t         pfo_pid_pprob[157];   //[pfo_n]
   Float_t         pfo_pid_hprob[157];   //[pfo_n]
   Int_t           pfo_piddedx[157];   //[pfo_n]
   Float_t         pfo_piddedx_likelihood[157];   //[pfo_n]
   Float_t         pfo_piddedx_eprob[157];   //[pfo_n]
   Float_t         pfo_piddedx_muprob[157];   //[pfo_n]
   Float_t         pfo_piddedx_piprob[157];   //[pfo_n]
   Float_t         pfo_piddedx_kprob[157];   //[pfo_n]
   Float_t         pfo_piddedx_pprob[157];   //[pfo_n]
   Float_t         pfo_piddedx_hprob[157];   //[pfo_n]
   Float_t         pfo_piddedx_e_dedxdist[157];   //[pfo_n]
   Float_t         pfo_piddedx_mu_dedxdist[157];   //[pfo_n]
   Float_t         pfo_piddedx_pi_dedxdist[157];   //[pfo_n]
   Float_t         pfo_piddedx_k_dedxdist[157];   //[pfo_n]
   Float_t         pfo_piddedx_p_dedxdist[157];   //[pfo_n]
   Float_t         pfo_piddedx_e_lkhood[157];   //[pfo_n]
   Float_t         pfo_piddedx_mu_lkhood[157];   //[pfo_n]
   Float_t         pfo_piddedx_pi_lkhood[157];   //[pfo_n]
   Float_t         pfo_piddedx_k_lkhood[157];   //[pfo_n]
   Float_t         pfo_piddedx_p_lkhood[157];   //[pfo_n]
   Float_t         pfo_pidtof_p_at_calo[157];   //[pfo_n]
   Float_t         pfo_pidtof_closest_beta_0ps[157];   //[pfo_n]
   Float_t         pfo_pidtof_closest_beta_10ps[157];   //[pfo_n]
   Float_t         pfo_pidtof_closest_beta_50ps[157];   //[pfo_n]
   Float_t         pfo_pidtof_closest_beta_100ps[157];   //[pfo_n]
   Float_t         pfo_pidtof_fastest_beta_0ps[157];   //[pfo_n]
   Float_t         pfo_pidtof_fastest_beta_10ps[157];   //[pfo_n]
   Float_t         pfo_pidtof_fastest_beta_50ps[157];   //[pfo_n]
   Float_t         pfo_pidtof_fastest_beta_100ps[157];   //[pfo_n]
   Float_t         pfo_pidtof_cylfit_beta_0ps[157];   //[pfo_n]
   Float_t         pfo_pidtof_cylfit_beta_10ps[157];   //[pfo_n]
   Float_t         pfo_pidtof_cylfit_beta_50ps[157];   //[pfo_n]
   Float_t         pfo_pidtof_cylfit_beta_100ps[157];   //[pfo_n]
   Float_t         pfo_pidtof_closestfit_beta_0ps[157];   //[pfo_n]
   Float_t         pfo_pidtof_closestfit_beta_10ps[157];   //[pfo_n]
   Float_t         pfo_pidtof_closestfit_beta_50ps[157];   //[pfo_n]
   Float_t         pfo_pidtof_closestfit_beta_100ps[157];   //[pfo_n]
