...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   virtual void     PreSelection(int, float, TString, TString);
...
#ifdef PreSelec_cxx
PreSelec::PreSelec(TString tree_s) : fChain(0) 
{
...
PreSelec::PreSelec(TList *f) : fChain(0) 
{
...
Int_t PreSelec::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t PreSelec::LoadTree(Long64_t entry)
{
...
void PreSelec::Show(Long64_t entry)
{
...
Int_t PreSelec::Cut(Long64_t entry)
{
