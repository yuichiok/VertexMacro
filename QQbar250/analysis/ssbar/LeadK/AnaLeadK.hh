...
#ifdef AnaLeadK_cxx
AnaLeadK::AnaLeadK(TString tree_s) : fChain(0) 
{
...
AnaLeadK::AnaLeadK(TList *f) : fChain(0) 
{
...
Int_t AnaLeadK::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t AnaLeadK::LoadTree(Long64_t entry)
{
...
void AnaLeadK::Show(Long64_t entry)
{
...
Int_t AnaLeadK::Cut(Long64_t entry)
{
