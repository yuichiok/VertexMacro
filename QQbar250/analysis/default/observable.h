...
public :
  ...
  Float_t         mc_hadron_E[1000];
  Float_t         mc_hadron_px[1000];
  Float_t         mc_hadron_py[1000];
  Float_t         mc_hadron_pz[1000];
  Float_t         mc_hadron_m[1000];
  Float_t         mc_hadron_pdg[1000];
  Float_t         mc_hadron_charge[1000];
  Int_t           mc_hadron_n;
