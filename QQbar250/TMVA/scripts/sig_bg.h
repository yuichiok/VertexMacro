...
// Wed Feb 10 16:23:52 2021 by ROOT version 6.18/04
...
#ifdef sig_bg_cxx
sig_bg::sig_bg(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/group/ilc/users/yokugawa/QQbar250/l5/eLpR/15162/adrian_sample/bbbar15162_radret_250GeV_mc2020_eL_ValenciaVertexBeam_R1.17_short2.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/group/ilc/users/yokugawa/QQbar250/l5/eLpR/15162/adrian_sample/bbbar15162_radret_250GeV_mc2020_eL_ValenciaVertexBeam_R1.17_short2.root");
      }
...
Int_t sig_bg::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t sig_bg::LoadTree(Long64_t entry)
{
...
void sig_bg::Show(Long64_t entry)
{
...
Int_t sig_bg::Cut(Long64_t entry)
{
