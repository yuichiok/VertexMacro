...
void btrack()
{
		...
		*/
		...
		TH2F * h_bntracks     = new TH2F("h_bntracks", ";Reco b ntracks;MC b ntracks", 20, 0, 20, 20, 0, 20) ;
		...
		normaltree->Draw("Top1bntracks:Top1Genbntracks >> h_bntracks");
		int accepted          = normaltree->Draw("Top1bntracks:Top1Genbntracks",  diag);
		int rejected          = normaltree->Draw("Top1bntracks:Top1Genbntracks", !diag);
		...
		cout << "Total    = " << total    << "\n";
		cout << "\n";
		cout << "Track reco eff = " << (float)(accepted) / (float)(total) << endl;
		cout << "====================" << endl;

		h_bntracks->Draw("COLZ");
