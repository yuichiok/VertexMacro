...
// Mon Nov 12 20:42:06 2018 by ROOT version 6.08/06
// from TTree Stats/tree
// found on file: /home/ilc/yokugawa/run/root_merge/new/large/leptonic_yyxyev_eLeR_new_large_QQbar_dEdx.root
//////////////////////////////////////////////////////////

#ifndef KaonHandler_h
#define KaonHandler_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Float_t         jet_pz[2];
   Float_t         jet_M[2];
   Float_t         kaon1_ntracks;
   Float_t         kaon1_dEdx[6][kaon1_ntracks];   //[Top1KaonNumber]
   Int_t           UsedBTVCM;
   Int_t           methodUsed;
   Int_t           methodRefused;
   Int_t           methodCorrect;
   ...
   TBranch        *b_MCBHadCharge;   //!
   TBranch        *b_MCBHadNtracks;   //!
...
#ifdef KaonHandler_cxx
KaonHandler::KaonHandler(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/home/ilc/yokugawa/run/root_merge/new/large/leptonic_yyxyev_eLeR_new_large_QQbar_dEdx.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/home/ilc/yokugawa/run/root_merge/new/large/leptonic_yyxyev_eLeR_new_large_QQbar_dEdx.root");
      }
...
KaonHandler::~KaonHandler()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t KaonHandler::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t KaonHandler::LoadTree(Long64_t entry)
{
...
void KaonHandler::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("MCBHadCharge", &MCBHadCharge, &b_MCBHadCharge);
   fChain->SetBranchAddress("MCBHadNtracks", &MCBHadNtracks, &b_MCBHadNtracks);
   ...
   fChain->SetBranchAddress("Top1Genbntracks", &Top1Genbntracks, &b_Top1Genbntracks);
   ...
   fChain->SetBranchAddress("Top2Genbntracks", &Top2Genbntracks, &b_Top2Genbntracks);
   ...
   fChain->SetBranchAddress("kaon1_ntracks", &kaon1_ntracks, &b_kaon1_ntracks);
...
void KaonHandler::Show(Long64_t entry)
{
...
Int_t KaonHandler::Cut(Long64_t entry)
{
