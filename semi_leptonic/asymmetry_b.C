...
void asymmetry_b()
{
  //TFile * file = TFile::Open(filename.c_str());
	...
	string fcuts = "((Top1bcostheta > 0 && Top1bcharge < 0) || (Top1bcostheta < 0 && Top1bcharge > 0)) " + cuts;
	string bcuts = "((Top1bcostheta > 0 && Top1bcharge > 0) || (Top1bcostheta < 0 && Top1bcharge < 0)) " + cuts;

	int recoforward = normaltree->Draw("-Top1bcostheta*Top1bcharge >> cosReco", fcuts.c_str());
	int recobackward = normaltree->Draw("-Top1bcostheta*Top1bcharge >> +cosReco", bcuts.c_str());
