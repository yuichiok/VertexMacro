...
void MC_noSingle()
{
	...
	normaltree->SetBranchAddress("chiTopMass1", &chiTopMass1);
	normaltree->SetBranchAddress("chiTopE1", &chiTopE1);
	normaltree->SetBranchAddress("chiPbstar1", &chiPbstar1);

	normaltree->SetBranchAddress("chiTopMass2", &chiTopMass2);
	normaltree->SetBranchAddress("chiTopE2", &chiTopE2);
	normaltree->SetBranchAddress("chiPbstar2", &chiPbstar2);
	...
	//			if(chiTopMass1 + chiTopE1 + chiPbstar1 < 30 || chiTopMass2 + chiTopE2 + chiPbstar2 < 30){

				if(Top1bmomentum > 30 && Top2bmomentum > 30){
